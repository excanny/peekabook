...
.preloader {
   ...
   height: 100%;
   z-index: 9999;
   background-image: url('<?php echo base_url();?>/public/assets/images/preloaders/Infinity-1s-200px.gif');
          ...
          <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive">
            ...
            <ul class="pull-right flip">
              <li>
                ...
                <!-- Modal: Book Now End -->
                <a class="btn btn-colored btn-flat bg-theme-color-orange text-white  bs-modal-ajax-load mt-0 p-25 font-16"><i class="fa fa-shopping-cart font-16"></i> (1)</a>
                  <!-- <ul class="dropdown">
                      <li>
                        <!-- dropdown cart -->
