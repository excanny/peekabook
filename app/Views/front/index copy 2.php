                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <div class="service-content ml-20 ml-sm-0">
                      ...
                      <a class="btn btn-lg btn-dark btn-theme-color-orange" href="<?php //echo site_url('personalize/'. $featured3['fbook_slug']);?>">Personalize This Book</a>
                    </div>
                  </div>
                </div>
              </div>
...
<section id="features" class="" data-bg-img="<?php echo base_url();?>/public/assets/images/bg/p2.jpg">
...
<!-- Divider: Contact -->
<section id="contact" class="divider" data-bg-img="<?php echo base_url();?>/public/assets/images/bg/p2.jpg">
