...
<?= $this->section('content') ?>
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider rev_slider_default" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?php echo base_url();?>/public/assets2/images/bg/bg1.jpg" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                <!-- MAIN IMAGE -->
                <div class="bg-video">
        <div class="twp-video-background">
          <div class="twp-video-foreground">
           <video autoplay muted loop id="myVideo">
            <source src="<?php echo base_url();?>/public/assets2/images/c-video.mp4" type="video/mp4">
           </video>
         </div>
          ...
          <div class="container pt-200 pb-200">
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <a class="btn btn-colored btn-theme-color-orange btn-flat smooth-scroll-to-target mt-20" href="#donate-now">Apply Now</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container pt-0">
        <div class="section-content" data-margin-top="90px">
          <div class="row">
            ...
            <div class="col-md-4">
              <img src="<?php echo base_url();?>/public/assets2/images/about/a1.png" alt="">
            </div>
          </div>
        </div>
      </div>
      <div> 
          <img alt="" src="<?php echo base_url();?>/public/assets2/images/bg/f2.png" class="img-responsive img-fullwidth">
      </div>
    </section>
  ...
  <section id="book">
                ...
                <div class="tab-content">
                  <div class="tab-pane fade in active" id="tab11">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="thumb">
                          <img class="img-fullwidth" src="<?php echo base_url();?>/public/assets2/images/services/1e.jpg" alt="">
                        </div>
                      </div>
                      <div class="col-md-7">
    ...
    <section id="features" class="" data-bg-img="<?php echo base_url();?>/public/assets2/images/bg/p2.jpg">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="icon-box left bg-theme-color-red border-radius-15px media p-20 pr-15 pl-15 mb-40"> <a class="media-left pull-left flip p-10" href="#"><i class="fa fa-graduation-cap text-white font-42"></i></a>
              ...
              <div class="item">
                <div class="testimonial-wrapper">                  
                  <div class="content bg-theme-color-orange p-30 pb-40">
                    ...
                    <div class="thumb mt-20"><img class="img-circle" alt="" src="<?php echo base_url();?>/public/assets2/images/testimonials/1.jpg"></div>
                  </div>                  
                </div>
              </div>
              <div class="item">
                <div class="testimonial-wrapper">                  
                  <div class="content bg-theme-color-lemon p-30 pb-40">
                    ...
                    <h4 class="author text-white mt-20 mb-0">Catherine Grace</h4>
                    <h6 class="title text-white mt-0 mb-15">Designer</h6>
                    <div class="thumb mt-20"><img class="img-circle" alt="" src="<?php echo base_url();?>/public/assets2/images/testimonials/2.jpg"></div>
                  </div>                  
                </div>
              </div>
              <div class="item">
                <div class="testimonial-wrapper">                  
                  <div class="content bg-theme-color-sky p-30 pb-40">
                    ...
                    <h4 class="author text-white mt-20 mb-0">Catherine Grace</h4>
                    <h6 class="title text-white mt-0 mb-15">Designer</h6>
                    <div class="thumb mt-20"><img class="img-circle" alt="" src="<?php echo base_url();?>/public/assets2/images/testimonials/3.jpg"></div>
                  </div>                  
                </div>
              </div>
            </div>
    ...
    <!-- Divider: Contact -->
    <section id="contact" class="divider" data-bg-img="<?php echo base_url();?>/public/assets2/images/bg/p2.jpg">
